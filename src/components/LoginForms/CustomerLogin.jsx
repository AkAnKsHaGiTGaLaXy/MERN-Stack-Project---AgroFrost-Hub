...
const CustomerLogin = () => {
  ...
  const handleForgotPassword = async () => {
    setFloading(true);
    try {
      const response = await axios.post(`${endpoint}/user/forgot-password`, {
        email: forgotemail,
      });
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${endpoint}/user/verify/otp`, {
        otp,
      });
  ...
  const handleChangePassword = async () => {
    try {
      ...
      await axios.post(`${endpoint}/user/change-password`, data);
      setFConfirmPassword("");
      setFPassword("");
      setForgotEmail("");
      setOtp("");
